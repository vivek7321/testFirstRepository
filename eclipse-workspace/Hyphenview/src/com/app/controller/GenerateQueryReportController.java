 ...
 */
@WebServlet("/GenerateQueryReportController")
public class GenerateQueryReportController extends HttpServlet {
     ...
     */
    public GenerateQueryReportController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		LOGGER.info("customQuery in GenerateQueryReportController --> " + customQuery);
		...
		if(request.getParameter("Back") != null){
			...
			if (request.getSession().getAttribute("roleName").toString().equalsIgnoreCase("ReportEndUser")) {
			getServletContext().getRequestDispatcher("/QueryOnlyReports.jsp").forward(request, response);
			} else {getServletContext().getRequestDispatcher("/QueryReports.jsp").forward(request, response);
			}
		}else if(request.getParameter("Save") != null){
			LOGGER.info("Save button pressed...");
			LOGGER.info("setReportType---"+reportType+"---templateType->"+templateType);
