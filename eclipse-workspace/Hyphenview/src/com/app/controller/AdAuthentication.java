...
public class AdAuthentication {
    ...
    public AdAuthentication(String domainName) throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        ...
        AdAuthentication authentication = new AdAuthentication("hyphenview.com");
        try {
             authResult = authentication.authenticate("super.admin", "Era@#123");
